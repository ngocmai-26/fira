  ...
  return (
    ...
    >
      <div className="relative w-full h-full max-w-4xl m-auto px-4 md:h-auto">
        ...
        >
          <div className=" items-start p-5 border-b rounded-t ">
                        ...
                        <div className="scheduleType">
                          <div className="calendar-grid">
                            {singlePlan?.planDetail?.planSchedules.map(
                              (item) => (
                                <div className="calendar-day text-sm px-2">
                            ...
                            <div className="border-b border-b-gray-300 mb-2 pb-2">
                              <div className=" text-md">
                                <div className="multi-line">
                                  <span className="text-red-400 multi-line">
                                    {item.title}
                                  </span>
                                </div>
                              </div>
                              <div className=" text-sm">
                                <div className="multi-line">
                                  <span className="text-xs multi-line">
