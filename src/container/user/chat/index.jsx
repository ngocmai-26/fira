      ...
      <div className="grid grid-cols-3 lg:grid-cols-4 h-screen relative">
        <div className="p-2 col-span-3 md:col-span-1 border-e-gray-100 border-e-2 h-screen">
          <div className="flex justify-between border-b-gray-100 border-b-2 py-2">
            ...
            <button className="bg-blue-500 text-lg text-white px-2">
        ...
        <div className={`col-span-3 md:col-span-2 p-2 border-e-gray-100 absolute w-full md:relative bg-white md:right-0 border-e-2 ${ expandBox ? "right-0" : "right-[-100vw]"}`}
          style={{
          ...
          <div className="flex justify-between border-b-gray-100 border-b-2">
            <div className="flex">
              <button className="come-back block md:hidden " onClick={handleExpandBox}>
